...
with col1:
    ...
    df_ev_data = pd.read_csv('Data/cleaned_ev_data_germany.csv', low_memory=False)
    ...
    # Note: Stamen tiles are causing issues with streamlit_folium, keeping only OpenStreetMap for now
